  ...
  return (
    <div className={styles.appHeader}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'start' }}>
        ...
        <span className="pl-2 pr-5 pb-4 pt-4" > Конструктор</span></div>
        <div className="pl-5 ml-2" style={{ display: 'flex', alignItems: 'center' }} >
        <ListIcon type="secondary" />
        <span className="pl-2  pr-5 pb-4 pt-4 mr-25" style={{ color: 'rgba(133, 133, 173, 1)' } }>Лента заказов</span></div>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'end',marginLeft: 289 }}>
        ...
        <span className="pr-5" style={{  color: 'rgba(133, 133, 173, 1)'}}>Личный кабинет</span>
      </div>
    </div>
  );
}
